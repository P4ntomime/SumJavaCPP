...
% \usepackage[default]{sourcesanspro} % change default to t1 for serife font 
\usepackage{multicol}
\usepackage{multirow}
\usepackage[top=3mm,bottom=6mm,left=2mm,right=3mm]{geometry}
\usepackage{wrapfig}
...
\usepackage[hidelinks,
            ...
            pdftitle={JavaC},
            pdfsubject={Java für C++ Programmierer HS23},
...
\newcommand{\limes}[1]{\underset{#1}{\lim}}
\newcommand{\ond}{\operatorname{d}}
...
\DeclareNewLayer[
    ...
    \colorbox{basegreen}{\parbox[c][\layerheight][c]{\layerwidth}{\centering\pagemark}}%
    }}
...
%Einführung, Grundkonzepte JVM, Eclipse
%Methoden
%Klassen und Objekte
%Vererbung
%VariadischeFunktionen / ArrayList
%Schnittstellen
%Spezielle Funktionen / Hash Container
%Generics
%Exceptions
%Lambdas
%Stream API
%Input/Output
%Einführung in GUI und Swing
%Packages, Enums, Wiederholung
	\end{multicols*}
